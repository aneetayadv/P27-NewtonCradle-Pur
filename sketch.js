...
function setup() {
    ...
    bob1= new Bob(400,350,bobRadius);
    bob2= new Bob(440,350,bobRadius);
    bob3= new Bob(480,350,bobRadius);
    bob4= new Bob(360,350,bobRadius);
    bob5= new Bob(320,350,bobRadius);
